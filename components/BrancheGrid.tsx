    ...
    <section className="border-y border-line bg-mist">
      <div className="container-x py-16 sm:py-24">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-3xl font-extrabold sm:text-4xl">Kleding afgestemd op uw sector</h2>
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Link href="/offerte"
            ...
            <div>
              ...
              <h3 className="mt-3 text-xl font-extrabold text-white">Staat uw branche er niet bij?</h3>
            ...
            <span className="mt-6 inline-flex items-center gap-2 text-sm font-bold uppercase tracking-wide text-amber-400">
              Vraag advies aan <span aria-hidden="true">→</span>
            </span>
          </Link>
        </div>
      </div>
